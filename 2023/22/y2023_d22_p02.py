...
# returns how many of the blocks are grounded, even when one is blocked
def grounded(blocked):
    Q = [0]
    seen = set()
    while Q:
        i = Q.pop()
...
for cur in range(1,brickNum):
    # print("we are looking at", cur)
    gr = grounded(cur)
    # print("We have", gr, "grounded, out of", brickNum)
    # print("this means that", brickNum - gr - 2, " fell")
    ans += brickNum - gr - 2
