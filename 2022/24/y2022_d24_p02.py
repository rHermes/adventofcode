...
def best(start_pos: posT, end_pos: posT, start_blizs: breezes) -> tuple[int, breezes]:
    my, mx = gsz
...
def solve():
    ...
    # print(blizs)
    start_to_end1, nblizs = best(start_pos, end_pos, frozenset(blizs))
    print("We spent {} min going from start to end".format(start_to_end1))
    end_to_start2, nblizs = best(end_pos, start_pos, nblizs)
    print("We spent {} min going from end to start".format(end_to_start2))
    start_to_end3, nblizs = best(start_pos, end_pos, nblizs)
    print("We spent {} min going from start to end again".format(start_to_end3))

    return start_to_end1 + end_to_start2 + start_to_end3
